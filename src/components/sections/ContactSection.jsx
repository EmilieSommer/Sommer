  ...
  return (
    <footer ref={sectionRef} className="content-section contact-footer" id="contact">
      <div className="section__inner">
        <h2 className="contact__heading r">Say hi.</h2>
        <p className="contact__sub r">Let's work together — or just talk design.</p>
        ...
        <p className="contact__copy r">© 2025 Emilie Sommer</p>
      </div>
    </footer>
  )
}
